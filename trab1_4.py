import math
from equacoes_diferenciais import metodoDeEuler, metodoDeRungeKutta4
...
# h = 0.25
pontos_x, pontos_y = metodoDeRungeKutta4(f, 1, 1, 8, 0.25)
...
pontos_x, pontos_y = metodoDeRungeKutta4(f, 1, 1, 20, 0.1)
...
# h = 0.05
pontos_x, pontos_y = metodoDeRungeKutta4(f, 1, 1, 40, 0.05)
